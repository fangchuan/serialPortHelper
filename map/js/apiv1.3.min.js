...
(function () {
	...
	a8.dom.getPosition = function (T) {
		...
		cP = (cN.ie && !cN.isStrict) ? cT.body : cT.documentElement,
		cU,
		cL;
		if (T == cP) {
			return cR
