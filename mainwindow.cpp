    ...
    ui(new Ui::MainWindow)
{
    ...
    connect(wifi, &wifiConnect::wifiConnection, this, &MainWindow::showStatusMessage);
}
...
void MainWindow::closeSerialPort()
{
    ...
    ui->actionDisconnect->setEnabled(false);
    ui->actionConfigure->setEnabled(true);
    showStatusMessage("Serial port disconnected");
}
//
...
void MainWindow::initActionsConnections()
{
    ...
    connect(ui->actionWifi,&QAction::triggered, wifi, &MainWindow::show);
    connect(ui->actionMapShow,&QAction::triggered, showMap, &MainWindow::show);
}
